...
class AnalyticalThermal:
    ...
    def get_composition_dependent_pressure(
        ...
        print("equilibrium charge fraction?", equilibrium_electron_fraction)
        symmetry_pressure = self.get_symmetry_pressure(
            rest_mass_density=rest_mass_density
        )
        print("python symmetry pressure", symmetry_pressure)
        return K_ * (
            electron_fraction ** (4 / 3)
            - equilibrium_electron_fraction ** (4 / 3)
    ...
    def get_temperature_dependent_pressure(
        ...
        fs = fs_of_temperature(temperature)
        electron_factor = electron_fraction ** (3 / 3)
        # electron_factor=1
        radiation_part = 4 / 3 * stefan_boltzmann_sigma_ * fs * temperature**4
        print("radiation part", radiation_part)
        ...
        print("baryon_degeneracy a", baryon_degeneracy_a)
        print("electron_degeneracy a", electron_degeneracy_a * electron_factor)
        degeneracy_part = (
            1
    ...
    def pressure_from_density_and_temperature(
        ...
        print(
            "python composition dependent pressure",
    ...
    def temperature_from_density_and_energy(
        ...
        print("temp_from_eps was", temp_from_eps.shape)
        print(rest_mass_density.shape)
        return (
...
if __name__ == "__main__":
    ...
    print(eos.get_equilibrium_charge_fraction(0.01 * 0.00045))
    N = 120
