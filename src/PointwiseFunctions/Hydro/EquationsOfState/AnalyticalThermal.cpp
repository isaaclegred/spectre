...
Scalar<double> AnalyticalThermal<ColdEos>::
...
Scalar<DataType> AnalyticalThermal<ColdEquationOfState>::
  ...
  return Scalar<DataType>{
      // Guarantee that the pressure is greater than or equal to zero even with
      // rounding error
      max(get(cold_eos_.pressure_from_density(rest_mass_density)) +
