...
void TovVariables<DataType, Region>::operator()(
    ...
    gsl::not_null<Cache*> /*cache*/,
    BnsInitialData::Tags::RotationalShift<DataType> /*meta*/) const {
...
void TovVariables<DataType, Region>::operator()(
    ...
    gsl::not_null<Cache*> /*cache*/,
    BnsInitialData::Tags::VelocityPotential<DataType> /*meta*/) const {
...
void TovVariables<DataType, Region>::operator()(
    ...
    gsl::not_null<Cache*> /*cache*/,
    ::Tags::deriv<BnsInitialData::Tags::VelocityPotential<DataType>,
...
void TovVariables<DataType, Region>::operator()(
    ...
    gsl::not_null<Cache*> cache,
    ::Tags::Flux<BnsInitialData::Tags::VelocityPotential<DataType>,
                 tmpl::size_t<3>, Frame::Inertial> /*meta*/) const {
  const auto& rotational_shift_stress = cache->get_var(
      *this, BnsInitialData::Tags::RotationalShiftStress<DataType>{});
  const auto& inverse_spatial_metric =
      get_tov_var(gr::Tags::InverseSpatialMetric<DataType, 3>{});
  const auto& auxiliary_velocity = cache->get_var(
      *this, ::Tags::deriv<BnsInitialData::Tags::VelocityPotential<DataType>,
                           tmpl::size_t<3>, Frame::Inertial>{});
...
void TovVariables<DataType, Region>::operator()(
  ...
  // The first term is from lapse + specific enthalpy derivatives,
  // second term is due to rest mass density derivative which involves the
  // speed of sound.
  ::tenex::evaluate<ti::i>(
...
void TovVariables<DataType, Region>::operator()(
    ...
    gsl::not_null<Cache*> cache,
    BnsInitialData::Tags::RotationalShiftStress<DataType> /*meta*/) const {
  const auto& rotational_shift =
      cache->get_var(*this, BnsInitialData::Tags::RotationalShift<DataType>{});
  const auto& lapse = cache->get_var(*this, gr::Tags::Lapse<DataType>{});
...
PUP::able::PUP_ID BnsInitialData::InitialData::TovStar::my_PUP_ID =
    0;  // NOLINT
