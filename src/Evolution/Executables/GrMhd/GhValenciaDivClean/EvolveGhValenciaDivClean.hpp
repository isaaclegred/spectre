 ...
 public:
  ...
  using initialize_initial_data_dependent_quantities_actions = tmpl::list<
      ...
      Actions::MutateApply<tmpl::conditional_t<
          use_dg_subcell, grmhd::GhValenciaDivClean::SetPiFromGauge,
...
struct EvolutionMetavars : public virtual GhValenciaDivCleanDefaults {
  ...
  using component_list = tmpl::flatten<tmpl::list<
      ...
      std::conditional_t<use_numeric_initial_data,
                         ...
                         tmpl::list<>>,
      intrp::Interpolator<EvolutionMetavars>, dg_element_array_component,
